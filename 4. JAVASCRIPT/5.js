...
let data = "JavaScript is the world's most popular programming language.JavaScript is the programming language of the world.";

// console.log(data.replace("world","skillqode"))
// console.log(data.replace(/world/g,"skillqode"))

// console.log(data.replaceAll("world","moye moye"))

// let txt  = "              hello world             ";
// console.log(txt);
// console.log(txt.trim());        // remove extraspace
